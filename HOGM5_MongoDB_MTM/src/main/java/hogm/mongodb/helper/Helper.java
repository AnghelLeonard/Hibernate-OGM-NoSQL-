...
public final class Helper {
    ...
    public static final transient String[][] PHOTOS = {{"novak_1.png", "novak_2.png", "novak_3.png"},
    {"federer_1.png", "federer_2.png"}, {"murray_1.png", "murray_2.png", "murray_3.png", "murray_4.png"},
    {"nadal_1.png", "nadal_2.png", "nadal_3.png", "nadal_4.png"}, {"ferrer_1.png", "ferrer_2.png"},
    {"berdych_1.png", "berdych_2.png", "berdych_3.png"}, {"delpotro_1.png", "delpotro_2.png", "delpotro_3.png", "delpotro_4.png"},
    {"tsonga_1.png", "tsonga_2.png"}, {"tipsarevic_1.png", "tipsarevic_2.png", "tipsarevic_3.png"},
    {"gasquet_1.png", "gasquet_2.png", "gasquet_3.png", "gasquet_4.png"}};
    
    public static final transient String[] TOURNAMENTS = {"Barclays ATP World Tour Finals", 
        "Shanghai Rolex Masters", "China Open", "Coupe Rogers", "Sony Open Tennis", "BNP Paribas Open", 
        "Aegon Championships", "Erste Bank Open", "Brisbane International", "Dubai Duty Free Tennis Championships", 
        "BMW Open", "If Stockholm Open", "ABN AMRO World Tennis Tournament", "Gerry Weber Open", 
        "Rakuten Japan Open Tennis Championships", "Open Sud de France"};
}
