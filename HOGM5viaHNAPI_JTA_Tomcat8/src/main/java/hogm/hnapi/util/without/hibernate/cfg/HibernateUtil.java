    ...
    static {
        try {
            ...
            StandardServiceRegistry registry = new StandardServiceRegistryBuilder()
                    ...
                    // set JTA platform
                    .applySetting(AvailableSettings.JTA_PLATFORM, "org.hibernate.service.jta.platform.internal.JBossStandAloneJtaPlatform")
                    .applySetting("com.arjuna.ats.jta.jtaTMImplementation", "com.arjuna.ats.internal.jta.transaction.arjunacore.TransactionManagerImple")
                    .applySetting("com.arjuna.ats.jta.jtaUTImplementation", "com.arjuna.ats.internal.jta.transaction.arjunacore.UserTransactionImple")
                    // assuming MongoDB as the backend
                    .applySetting(OgmProperties.DATASTORE_PROVIDER, MongoDB.DATASTORE_PROVIDER_NAME)
                    .applySetting(OgmProperties.DATABASE, "tomcat_db")
