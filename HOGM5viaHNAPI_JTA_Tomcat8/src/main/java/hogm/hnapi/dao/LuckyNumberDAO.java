...
public class LuckyNumberDAO {
    ...
    public void persist_cs_without_cfg(LuckyNumberEntity transientInstance) throws java.lang.Exception {
        ...
        try {
            tx.begin();
            hogm.hnapi.util.without.hibernate.cfg.HibernateUtil.getOgmSessionFactory().getCurrentSession().persist(transientInstance);
            tx.commit();
    ...
    public void persist_cs_with_cfg(LuckyNumberPojo transientInstance) throws java.lang.Exception {
        ...
        try {
            tx.begin();
            hogm.hnapi.util.with.hibernate.cfg.HibernateUtil.getOgmSessionFactory().getCurrentSession().persist(transientInstance);
            tx.commit();
